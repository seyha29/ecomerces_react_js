    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-600 mb-2">{t('cart.empty.title', 'Your cart is empty')}</h3>
          <p className="text-gray-500 mb-6">{t('cart.empty.description', 'Add some products to get started')}</p>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">
        {t('cart.title', 'Shopping Cart')} ({getTotalItems()})
      </h1>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="card p-6 sticky top-24">
            <h3 className="text-lg font-semibold mb-4">{t('checkout.orderSummary', 'Order Summary')}</h3>

            <div className="space-y-3 mb-6">
              <div className="flex justify-between text-gray-600">
                <span>
                  {t('checkout.subtotal', 'Subtotal')} ({getTotalItems()}{' '}
                  {getTotalItems() === 1 ? t('checkout.items.singular', 'item') : t('checkout.items.plural', 'items')})
                </span>
              ...
              <div className="flex justify-between text-gray-600">
                ...
                <span className={shipping === 0 ? 'text-green-600' : ''}>
                  {shipping === 0 ? t('checkout.freeShipping', 'FREE') : `$${shipping.toFixed(2)}`}
                </span>
              </div>
              <div className="flex justify-between text-gray-600">
            ...
            {subtotal < 50 && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                <p className="text-sm text-blue-700">
                  {t('cart.freeShippingPrompt', 'Add ${{amount}} more to get free shipping!').replace(
                    '{{amount}}',
            ...
            <div className="mt-6 pt-6 border-t">
              <p className="text-xs text-gray-500 text-center mb-2">
                {t('cart.secureCheckout', 'Secure checkout with')}
              </p>
